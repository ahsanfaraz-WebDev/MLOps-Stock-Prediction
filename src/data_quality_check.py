...
def check_data_quality(file_path, null_threshold=None):
    ...
    try:
        ...
        return False
    print(f"[PASS] File readable")
    
    # Check 3: No empty dataframe
    if df.empty:
        print(f"[FAIL] DataFrame is empty")
        return False
    print(f"[PASS] DataFrame is not empty ({len(df)} rows)")
    ...
    if missing_cols:
        ...
        return False
    print(f"[PASS] All required columns present: {', '.join(required_cols)}")
    ...
    if null_percentage > null_threshold:
        ...
        return False
    print(f"[PASS] Null percentage within threshold")
    ...
    for col in required_cols:
        ...
        status = "[PASS]" if null_pct < (null_threshold * 100) else "[FAIL]"
    ...
    if negative_prices:
        ...
        return False
    print(f"\n[PASS] No negative prices detected")
    ...
    if negative_volume:
        ...
        return False
    print(f"[PASS] No negative volume detected")
    ...
    if high_low_invalid > 0:
        ...
        return False
    print(f"[PASS] High >= Low for all rows")
    ...
    if high_open_invalid > 0 or high_close_invalid > 0:
        ...
        return False
    print(f"[PASS] High >= Open and Close for all rows")
    ...
    if low_open_invalid > 0 or low_close_invalid > 0:
        ...
        return False
    print(f"[PASS] Low <= Open and Close for all rows")
